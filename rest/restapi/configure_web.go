...
//go:generate swagger generate server --target ..\..\rest --name Web --spec ..\..\swagger.yml --principal models.Principal

func configureFlags(api *operations.WebAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.WebAPI) http.Handler {
